"""Offline Phase 3.4.5 replay using semantic evaluator v3.

Consumes the frozen 240 raw understandings. No OpenAI, MCP, SQL, or executable
Eloquent. It measures the validated Phase 3.4.4 canonicalizer plus the isolated
previous-calendar-year compiler addition, while comparing grouping by semantic
fingerprint rather than serialization shape.
"""
