  ...
  return (
    <main className="app-shell">
      ...
      <div className="workspace">
        <aside className="sidebar"><div className="sidebar-label">ESPACIO DE TRABAJO</div><button className="nav-item nav-item--active">⌁ <span>Análisis</span></button><button className="nav-item" onClick={() => document.getElementById("history")?.scrollIntoView({ behavior: "smooth" })}>◷ <span>Historial</span></button><div className="sidebar-footer"><span className="eyebrow">ESTADO DEL SISTEMA</span><p>Datos y políticas con trazabilidad.</p></div></aside>
