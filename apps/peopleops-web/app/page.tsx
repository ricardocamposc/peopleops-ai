  ...
  return (
    <main className="app-shell">
      ...
      <div className="workspace">
        <aside className="sidebar"><div className="sidebar-label">ESPACIO DE TRABAJO</div><Link className="nav-item nav-item--active" href="/"><span aria-hidden="true">⌁</span><span>Análisis</span></Link><button className="nav-item" onClick={() => document.getElementById("history")?.scrollIntoView({ behavior: "smooth" })}><span aria-hidden="true">◷</span><span>Historial</span></button><Link className="nav-item" href="/policies"><span aria-hidden="true">▣</span><span>Policies</span></Link><Link className="nav-item" href="/human-review"><span aria-hidden="true">◈</span><span>Human Review</span></Link><div className="sidebar-footer"><span className="eyebrow">ESTADO DEL SISTEMA</span><p>Datos y políticas con trazabilidad.</p></div></aside>
